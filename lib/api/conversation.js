...
function monthAsString(monthIndex) {
  return ['January', 'February', 'March', 'April', 'May', 'June', 'July','August','September','October','November','December'][monthIndex % 12];
}
...
module.exports = {
  ...
  message: function(params, callback) {
    ...
    var context = {
      today: d + ' ' + monthAsString(m),
      tomorrow: (d + 1) + ' ' + monthAsString(m)
    };
